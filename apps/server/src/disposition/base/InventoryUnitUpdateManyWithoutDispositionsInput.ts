...
@InputType()
class InventoryUnitUpdateManyWithoutDispositionsInput {
...
export { InventoryUnitUpdateManyWithoutDispositionsInput as InventoryUnitUpdateManyWithoutDispositionsInput };
