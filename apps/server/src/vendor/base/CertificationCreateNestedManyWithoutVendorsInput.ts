...
@InputType()
class CertificationCreateNestedManyWithoutVendorsInput {
...
export { CertificationCreateNestedManyWithoutVendorsInput as CertificationCreateNestedManyWithoutVendorsInput };
