...
@InputType()
class ContractCreateNestedManyWithoutCertificationsInput {
...
export { ContractCreateNestedManyWithoutCertificationsInput as ContractCreateNestedManyWithoutCertificationsInput };
