...
@InputType()
class InventoryUnitUpdateManyWithoutStorageLocationsInput {
...
export { InventoryUnitUpdateManyWithoutStorageLocationsInput as InventoryUnitUpdateManyWithoutStorageLocationsInput };
